...
const FString QuestRewardMaster::FileName = "QuestReward.bin";

void QuestRewardMaster::Load()
{
...
const QuestRewardItem *QuestRewardMaster::Get(u32 Key, int32 SheetIndex) const
{
