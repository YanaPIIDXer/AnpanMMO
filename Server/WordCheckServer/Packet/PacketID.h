...
public:
	...
	enum EID
	{
		...
		CacheItemShortcutRequest,
		CacheItemShortcutResponse,
		CacheSaveItemShortcutRequest,
		CacheSaveItemShortcutResponse,
		CacheQuestDataRequest,
		CacheQuestDataResponse,
		CacheSaveQuestDataRequest,
		CacheQuestRetireRequest,
		CacheSaveActiveQuestRequest,
		SendChat,
		ReceiveChat,
		GameReady,
		AreaMove,
		...
		ItemSubtract,
		ItemSubtractRequest,
		SaveItemShortcutRequest,
		SaveItemShortcutResult,
		LogInRequest,
		LogInResult,
