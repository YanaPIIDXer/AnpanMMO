...
bool ClientStateTitle::OnRecvCacheCharacterDataResult(MemoryStreamInterface *pStream)
{
	...
	PacketCharacterStatus StatusPacket(pClient->GetUuid(), Packet.Name, Packet.Job, Packet.Level, Param.MaxHp, Param.MaxHp, Param.Str, Param.Def, Packet.Exp, Packet.Gold);
